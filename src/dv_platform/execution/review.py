...
def _module_decisions(module: RTLModule) -> tuple[DesignDecision, ...]:
    ...
    decisions.extend(_clock_reset_decisions(module, procedural))
    ...
    decisions.extend(_memory_cdc_decisions(module))

    decisions.extend(_verification_quality_decisions(module, procedural, assignments, has_output_ports))

    return tuple(decisions)


def _clock_reset_decisions(module: RTLModule, procedural: bool) -> list[DesignDecision]:
    decisions: list[DesignDecision] = []
...
def _memory_cdc_decisions(module: RTLModule) -> list[DesignDecision]:
    decisions: list[DesignDecision] = []
    if module.memories:
...
def _verification_quality_decisions(
    module: RTLModule,
    procedural: bool,
    assignments: bool,
...
__name__ = "dv_platform.analysis.review"
