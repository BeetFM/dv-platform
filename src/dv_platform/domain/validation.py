...
from dv_platform.domain.models import VerificationTarget
from dv_platform.domain.schema import VALIDATION_RESULT_SCHEMA_VERSION
...
for _value in tuple(globals().values()):
    if isinstance(_value, type) and getattr(_value, "__module__", None) == __name__:
        _value.__module__ = "dv_platform.core.validation"
del _value
