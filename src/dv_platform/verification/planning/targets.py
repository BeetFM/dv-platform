...
for _legacy_class in (ScenarioRendererRegistration, ScenarioRendererRegistry):
    _legacy_class.__module__ = "dv_platform.generators.scenario_registry"
del _legacy_class

# The compatibility module is a true alias; retain its historical module name
# so package-child discovery and legacy pickling continue to behave identically.
__name__ = "dv_platform.generators.scenario_registry"
